...
function thinkup_customizer_theme_options( $wp_customize ) {
	...
	$wp_customize->add_section(
		new thinkup_customizer_customswitch_button_link(
			...
			array(
				...
				'priority'     => 1,
				'button_text' => __( 'Upgrade Now', 'harest' ),
				'button_url'  => '//www.thinkupthemes.com/themes/harest/',
	...
	$wp_customize->add_section(
		new thinkup_customizer_customswitch_button_link(
			...
			array(
				'title'        => __( 'Documentation', 'harest' ),
				'priority'     => 1,
				'button_text' => __( 'View Docs', 'harest' ),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'text',
			'label'			  => __( '', 'harest' ),
			'description'	  => __( 'Description', 'harest' ),
			'active_callback' => 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_upgrade(
			...
			array(
				...
				'price_discount'  => __( 'Upgrade for $31 (10% off)', 'harest' ),
				'price_normal'	  => __( 'Normally $35. Use coupon at checkout.', 'harest' ),
				'coupon'	      => __( 'harest31', 'harest' ),
