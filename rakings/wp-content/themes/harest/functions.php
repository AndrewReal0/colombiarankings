...
if ( ! function_exists( 'thinkup_themesetup' ) ) {
	...
	function thinkup_themesetup() {
		...
		load_theme_textdomain( 'harest', get_template_directory() . '/languages' );
		...
		$thinkup_header_args = apply_filters( 'thinkup_custom_header', array( 'height' => 200, 'width'  => 1600, 'header-text' => false ) );
		...
		register_nav_menus( array( 'pre_header_menu' => __( 'Pre Header Menu', 'harest' ) ) );
		register_nav_menus( array( 'header_menu'     => __( 'Primary Header Menu', 'harest' ) ) );
		register_nav_menus( array( 'sub_footer_menu' => __( 'Footer Menu', 'harest' ) ) );
	}
}
...
function thinkup_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 1', 'harest'),
        'id'            => 'footer-w1',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 2', 'harest'),
        'id'            => 'footer-w2',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 3', 'harest'),
        'id'            => 'footer-w3',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 4', 'harest'),
        'id'            => 'footer-w4',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 5', 'harest'),
        'id'            => 'footer-w5',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 6', 'harest'),
        'id'            => 'footer-w6',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
